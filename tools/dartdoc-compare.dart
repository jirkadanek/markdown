...
int main(List<String> arguments) {
  ...
  var comparer = new DartdocCompare()
    ...
    ..dartdoc_bin = "${options[dartdoc_dir]}/bin/dartdoc.dart"
    ..dartdoc_pubspec_path = "${options[dartdoc_dir]}/pubspec.yaml"
    ..sdk = options[sdk] ? "--sdk-docs --dart-sdk=" : "";
...
class DartdocCompare {
  ...
  run_dartdoc(markdown_ref, package) {
    ...
    return doInPath(package, () {
      ...
      var sdk_options = (sdk != "") ? sdk + package : "";
      var cmd = "dart";
